    ...
    <div class="row">
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-right">
                <?php echo anchor('prodi/add/', '<button class="btn waves-effect waves-light btn-rounded btn-success text-center">Tambah Data</button>'); ?>        
                    ...
                    <div class="table-responsive">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>  
                                    <td><?php echo $no ?></td>
                                    <td><?php echo $u->kode_prodi ?></td>
                                    <td><?php echo $u->nama_prodi ?></td>
                                    <td><?php echo $u->nama_fakultas ?></td>
                                    <td><?php echo $u->singkatan_prodi ?></td>
                                    <td>
                                        <?php echo anchor('mahasiswa/lihat/'.$u->id, '<button type="button" class="btn btn-success text-center" style="margin-top:10px;width:100%;">Lihat Data</button>'); ?>
                                        <?php echo anchor('mahasiswa/edit/'.$u->id, '<button type="button" class="btn btn-primary text-center" style="margin-top:10px;width:100%;">Edit Data</button>'); ?>
                                        <a href="<?php echo base_url() ?>mahasiswa/hapus/<?php echo $u->id ?>" class="btn btn-danger text-center" style="margin-top:10px;width:100%;" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">Hapus Data</a>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
                            </tbody>
