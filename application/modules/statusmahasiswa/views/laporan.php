...
<div class="container-fluid" style="margin-top:40px">
		...
		<tr>  
			...
			<?php } ?>
			<td>
			<?php echo anchor('proposal/history/'.$u->id_mahasiswa,'<button type="button" class="btn btn-success text-center" style="margin-top:10px;width:100%;">History Laporan</button>'); ?>
			</td>
			<?php $no++; ?>
		</tr>
		<?php } ?>
