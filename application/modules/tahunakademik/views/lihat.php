            ...
            <div class="card">
                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="itemtext"><?php echo $peserta['kode_thn_akad'] ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="itemtext"><?php echo $peserta['nama_thn_akad'] ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="itemtext"><?php echo $peserta['smt_akad'] ?></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="col-sm-12 text-center mt-3">
                        <?php echo anchor('nilaiproposal','<button type="button" class="btn btn-danger text-center" style="margin-top:10px;width:30%;">Kembali</button>'); ?>
                    </div>
                    <!-- End Invoice-->
                    <!-- End Invoice Holder-->
                </div>
