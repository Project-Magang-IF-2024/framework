                        ...
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>  
                                    ...
                                    <td><?php echo $u->paraf_pembimbing == 1 ? 'Diterima' : 'Ditolak'?></td>
                                    <td>
                                        <?php echo anchor('bimbinganproposal/lihat/'.$u->id, '<button type="button" class="btn btn-success text-center" style="margin-top:10px;width:100%;">Lihat Data</button>'); ?>
                                        <?php echo anchor('bimbinganproposal/edit/'.$u->id, '<button type="button" class="btn btn-primary text-center" style="margin-top:10px;width:100%;">Edit Data</button>'); ?>
                                        <a href="<?php echo base_url() ?>bimbinganproposal/hapus/<?php echo $u->id ?>" class="btn btn-danger text-center" style="margin-top:10px;width:100%;" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">Hapus Data</a>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
                            </tbody>
